...
using A_MNY9M._2_Application.Events.UserUpdated;
using A_MNY9M._2_Application.Implementations.Managers;
using A_MNY9M._2_Application.Events.ReactionAdded;
using A_MNY9M._2_Application.Interfaces.Managers;
using A_MNY9M._2_Application.Events.MessageReceived;
using A_MNY9M._2_Application.Events.UserVoiceStateUpdated;
using A_MNY9M._2_Application.Interfaces.Services;
using A_MNY9M._2_Application.Events.SlashCommandExecuted;
using A_MNY9M._2_Application.Implementations.Services;
using A_MNY9M._3_Infrastructure.Implementations.Repositiory;
using A_MNY9M._3_Infrastructure.Interfaces.ChatGPT;
using A_MNY9M._3_Infrastructure.Providers.Implementations.Configuration.App;
using A_MNY9M._3_Infrastructure.Interfaces.Discord;
using A_MNY9M._3_Infrastructure.Implementations.Services;
using A_MNY9M._3_Infrastructure.Providers.Implementations.Configuration.Messages;
using A_MNY9M._3_Infrastructure.Implementations.Managers;
using A_MNY9M._3_Infrastructure.Providers.Interfaces.Configuration.App;
using A_MNY9M._3_Infrastructure.Database.EF;
using A_MNY9M._3_Infrastructure.Implementations.Builders;
using A_MNY9M._3_Infrastructure.Providers.Interfaces.Configuration.Messages;
using A_MNY9M._3_Infrastructure.Providers.Implementations.Hubs;
using A_MNY9M._3_Infrastructure.Providers.Interfaces.Hubs;
using A_MNY9M._3_Infrastructure.Providers.Implementations.Configuration.Guild;
...
public static class A_MNY9M_DependencyRegistrator
{
    ...
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services)
    {
        ...
        services.AddDbContext<AmnyamDbContext>(
            (sp, options) =>
            {
    ...
    public static IServiceCollection AddPresentationServices(this IServiceCollection services)
    {
        ...
        services.AddHostedService<A_MNY9M_HostedService>();
